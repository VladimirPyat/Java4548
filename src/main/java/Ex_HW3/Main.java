...
//
//
//        Приложение должно проверить введенные данные по количеству. Если количество не совпадает с требуемым, вернуть код ошибки,обработать
...
public class Main {
    ...
    private static void menu() {
        ...
        do {
            ...
            System.out.print("1 - Создать запись;\n" +
                    "2 - Просмотр записи;\n" +
                    "0 - Выход.\n" +
    ...
    private static void readNote() {
        System.out.println("Просмотр контакта");
